...
export default function Home() {
  ...
  <div className="backdrop-blur-md bg-[rgb(21,24,33)]/40 border border-cyan-400/20 rounded-lg p-4 md:p-8 lg:p-12 shadow-[0_0_30px_rgba(6,182,212,0.15)]">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
          ...
          <table className="w-full text-sm min-w-[500px] md:min-w-0">
            <thead>
              <tr className="border-b border-cyan-400/30">
                <th className="text-left py-2 px-1 md:px-2 text-cyan-400 font-mono text-xs md:text-sm">Session</th>
                <th className="text-left py-2 px-1 md:px-2 text-cyan-400 font-mono text-xs md:text-sm">Topic</th>
                <th className="text-left py-2 px-1 md:px-2 text-cyan-400 font-mono text-xs md:text-sm">Duration</th>
                <th className="text-left py-2 px-1 md:px-2 text-cyan-400 font-mono text-xs md:text-sm">Outcome</th>
              </tr>
            </thead>
            <tbody className="text-gray-300 font-mono text-xs">
              {[
                ...
                <tr key={index} className="border-b border-cyan-400/10 hover:bg-cyan-400/5 transition-colors">
                  <td className="py-2 px-1 md:px-2 text-cyan-400 whitespace-nowrap">{row.session}</td>
                  <td className="py-2 px-1 md:px-2">{row.topic}</td>
                  <td className="py-2 px-1 md:px-2 text-cyan-300 whitespace-nowrap">{row.duration}</td>
                  <td className="py-2 px-1 md:px-2 text-gray-400">{row.outcome}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      {/* Machine Learning */}
      <div className="backdrop-blur-sm bg-green-900/10 border border-green-400/30 rounded-lg p-4 md:p-6 hover:shadow-[0_0_25px_rgba(34,197,94,0.3)] transition-all">
        <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-green-400 mb-4 md:mb-6 text-center font-mono">
          ...
          <table className="w-full text-sm min-w-[500px] md:min-w-0">
            <thead>
              <tr className="border-b border-green-400/30">
                <th className="text-left py-2 px-1 md:px-2 text-green-400 font-mono text-xs md:text-sm">Session</th>
                <th className="text-left py-2 px-1 md:px-2 text-green-400 font-mono text-xs md:text-sm">Topic</th>
                <th className="text-left py-2 px-1 md:px-2 text-green-400 font-mono text-xs md:text-sm">Duration</th>
                <th className="text-left py-2 px-1 md:px-2 text-green-400 font-mono text-xs md:text-sm">Outcome</th>
              </tr>
            </thead>
            <tbody className="text-gray-300 font-mono text-xs">
              {[
                ...
                <tr key={index} className="border-b border-green-400/10 hover:bg-green-400/5 transition-colors">
                  <td className="py-2 px-1 md:px-2 text-green-400 whitespace-nowrap">{row.session}</td>
                  <td className="py-2 px-1 md:px-2">{row.topic}</td>
                  <td className="py-2 px-1 md:px-2 text-green-300 whitespace-nowrap">{row.duration}</td>
                  <td className="py-2 px-1 md:px-2 text-gray-400">{row.outcome}</td>
                </tr>
              ))}
            </tbody>
