...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[rgb(15,18,25)] text-white">
      ...
      <section className="container mx-auto px-4 py-8 md:py-12">
        <div className="backdrop-blur-md bg-[rgb(21,24,33)]/40 border border-cyan-400/20 rounded-lg p-4 md:p-8 lg:p-12 shadow-[0_0_30px_rgba(6,182,212,0.15)]">
          <div className="text-center mb-6 md:mb-8">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-cyan-400 drop-shadow-[0_0_20px_rgba(6,182,212,0.8)]">
          ...
          <div className="flex justify-center">
            <div className="w-full max-w-5xl">
              {/* Web Development */}
              <div className="backdrop-blur-sm bg-cyan-900/10 border border-cyan-400/30 rounded-lg p-4 md:p-6 hover:shadow-[0_0_25px_rgba(6,182,212,0.3)] transition-all">
                <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-cyan-400 mb-4 md:mb-6 text-center font-mono">
                  ...
                  <table className="w-full text-sm min-w-[600px] md:min-w-0">
                    <thead>
                      <tr className="border-b border-cyan-400/30">
                        <th className="text-left py-2 px-1 md:px-3 text-cyan-400 font-mono text-xs md:text-sm">Session</th>
                        <th className="text-left py-2 px-1 md:px-3 text-cyan-400 font-mono text-xs md:text-sm">Topic</th>
                        <th className="text-left py-2 px-1 md:px-3 text-cyan-400 font-mono text-xs md:text-sm">Duration</th>
                        <th className="text-left py-2 px-1 md:px-3 text-cyan-400 font-mono text-xs md:text-sm">Outcome</th>
                      </tr>
                    </thead>
                    <tbody className="text-gray-300 font-mono text-xs md:text-sm">
                      {[
                        { session: '1', topic: 'Node.js & NPM Setup (LTS)', duration: '0.25 hr', outcome: 'Install Node.js LTS & NPM globally' },
                        { session: '2', topic: 'Intro to Backend & Servers', duration: '0.25 hr', outcome: 'Understand how backend works & serves data' },
                        { session: '3', topic: 'Express.js Basics', duration: '0.5 hr', outcome: 'Create and test REST APIs using Express' },
                        { session: '4', topic: 'MongoDB Atlas Setup', duration: '0.25 hr', outcome: 'Create cluster, connect with URI, use database' },
                        { session: '5', topic: 'Integrating Node + Express + MongoDB', duration: '0.5 hr', outcome: 'Build and test full API endpoint' },
                        { session: '6', topic: 'Postman Hands-on', duration: '0.25 hr', outcome: 'Send requests, test routes, and validate responses' },
                        { session: '7', topic: 'Live Testing + Q&A', duration: '0.25 hr', outcome: 'Deploy locally & interact with API live' },
                        { session: '8', topic: 'Offline Assessment', duration: '0.25 hr', outcome: '20 MCQs on core backend concepts' },
                      ].map((row, index) => (
                        <tr key={index} className="border-b border-cyan-400/10 hover:bg-cyan-400/5 transition-colors">
                          <td className="py-3 px-1 md:px-3 text-cyan-400 whitespace-nowrap font-semibold">{row.session}</td>
                          <td className="py-3 px-1 md:px-3 text-gray-200">{row.topic}</td>
                          <td className="py-3 px-1 md:px-3 text-cyan-300 whitespace-nowrap">{row.duration}</td>
                          <td className="py-3 px-1 md:px-3 text-gray-400">{row.outcome}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
                ...
                <div className="mt-4 pt-4 border-t border-cyan-400/20 text-center">
                  <p className="text-cyan-400 font-mono text-sm md:text-base">
                    ...
                    <span className="font-bold">Total Duration:</span> ~2.5 hours
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="backdrop-blur-md bg-[rgb(21,24,33)]/40 border border-pink-400/30 rounded-lg p-8 md:p-12 shadow-[0_0_30px_rgba(236,72,153,0.15)]">
          ...
          <div className="max-w-md mx-auto mb-8">
            <div className="backdrop-blur-sm bg-cyan-900/10 border border-cyan-400/30 rounded-lg p-6 text-center">
              ...
              <h4 className="text-2xl font-bold text-white mb-4">Prof. Suren Kumar Sahu</h4>
